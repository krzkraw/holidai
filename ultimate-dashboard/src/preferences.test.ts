...
describe('dashboard preferences persistence', () => {
  ...
  it('round-trips favorites and toolbar choices through local storage shape', () => {
    ...
    const preferences = {
      ...
      dynamicBackgroundShader: false,
      lengths: { Albania: '8' },
      lightweightMobileVisuals: true,
      mobilePerformanceNoticeDismissed: true,
  ...
  it('drops invalid destination buckets instead of trusting arbitrary storage data', () => {
    ...
    storage.setItem(
      ...
      JSON.stringify({
        ...
        dynamicBackgroundShader: true,
        lengths: { Albania: '14', Mars: '8', Cypr: 11 },
        lightweightMobileVisuals: false,
        mobilePerformanceNoticeDismissed: 'bad',
